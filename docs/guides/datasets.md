...
llm-forge поддерживает загрузку данных из локальных файлов, API и HuggingFace Hub. Данные автоматически очищаются (удаление дубликатов, пустых строк) и разбиваются на train/test.
...
2. **Дедупликация**: llm-forge автоматически удаляет дубликаты, но лучше проверить данные заранее.
...
llm-forge поддерживает загрузку датасетов напрямую с HuggingFace:
