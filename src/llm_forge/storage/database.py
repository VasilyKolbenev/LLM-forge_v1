"""Core SQLite database management for llm-forge.
...
Usage::
    ...
    from llm_forge.storage import get_database
...
from llm_forge.storage.schema import BOOTSTRAP_SQL, SCHEMA_VERSION

logger = logging.getLogger(__name__)

DEFAULT_DB_PATH = Path("./data/llm_forge.db")
